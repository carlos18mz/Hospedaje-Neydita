...
CREATE CERTIFICATE cerObtenerHabitacion
ENCRYPTION BY PASSWORD = 'HNEYDITA20'
WITH SUBJECT = 'QUERY PARA OBTENER HABITACION POR RESERVA',
EXPIRY_DATE = '2020-12-15'
GO

CREATE CERTIFICATE cerObtenerEventoPorDia
ENCRYPTION BY PASSWORD = 'HNEYDITA20'
WITH SUBJECT = 'QUERY PARA OBTENER LOS EVENTOS QUE SE VAN A REALIZAR EN EL DIA',
EXPIRY_DATE = '2020-12-15'
GO

CREATE CERTIFICATE cerSolicitarProductoParaHabitacion
ENCRYPTION BY PASSWORD = 'HNEYDITA20'
WITH SUBJECT = 'QUERY PARA SOLICITAR UN PEDIDO A LA HABITACION DE UN CLIENTE', 
EXPIRY_DATE = '2020-12-15'
GO
--=====Firma digital===========================

ADD SIGNATURE TO USP_OBTENERHABITACIONPORRESERVA
BY CERTIFICATE cerObtenerHabitacion
WITH PASSWORD = 'HNEYDITA20'
GO

ADD SIGNATURE TO USP_OBTENEREVENTOPORDIA
BY CERTIFICATE cerObtenerEventoPorDia
WITH PASSWORD = 'HNEYDITA20'
GO

ADD SIGNATURE TO USP_SOLICITARPRODUCTOAHABITACION
BY CERTIFICATE cerSolicitarProductoParaHabitacion
WITH PASSWORD = 'HNEYDITA20'
